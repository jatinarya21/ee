                    ...
                    <Row>
                        ...
                        <div className='d-flex flex-column  gap-5'>
                            <div data-aos="fade-down" className='d-flex justify-content-between align-items-center pb-2 border-bottom'>
                                <p className='text-white ff-raleway fw-400 text-uppercase fs-18'>Round 1</p>
                        ...
                        <h2 data-aos="fade-down" className='text-white text-center ff-raleway text-decoration-underline fs-20 pt-5 mt-2 pb-3'>(47,777 or around <span className='fs-36 numeric'>28%</span> of total starting supply is up for IBO)</h2>
